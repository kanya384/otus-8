...
func (s OrderSaga) OnPaymentConfirmed(ctx context.Context, evnt *OrderPaymentConfirmed_v1) error {
	_, err := s.repository.UpdateOrder(ctx, evnt.OrderUUID, func(ctx context.Context, or *order.Order) (*order.Order, error) {
		or.PaymentConfirmed()
...
func (s OrderSaga) OnPaymentFailed(ctx context.Context, event *OrderPaymentFailed_v1) error {
	_, err := s.repository.UpdateOrder(ctx, event.OrderUUID, func(ctx context.Context, or *order.Order) (*order.Order, error) {
...
func (s OrderSaga) OnOrderProductsReserved(ctx context.Context, evt *StockProductsReserved_v1) error {
	_, err := s.repository.UpdateOrder(ctx, evt.OrderUUID, func(ctx context.Context, or *order.Order) (*order.Order, error) {
